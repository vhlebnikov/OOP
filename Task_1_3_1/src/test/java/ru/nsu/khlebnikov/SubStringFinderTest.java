...
public class SubStringFinderTest {
    ...
    public void testWithRussianLetters() throws IOException {
        ...
        List<Pair<Integer>> actual = SubStringFinder.findSubString("input_rus.txt", "пирог");
    ...
    public void anotherTest() throws IOException {
        List<Pair<Integer>> expected =
                List.of(Pair.create(0, 0), Pair.create(0, 2), Pair.create(0, 4),
                        ...
                        Pair.create(2, 5));
        List<Pair<Integer>> actual = SubStringFinder.findSubString("input1.txt", "dad");
        assertEquals(actual, expected);
    }

    @Test
    public void warAndPeaceTest() throws IOException {
        List<Pair<Integer>> actual = SubStringFinder.findSubString("WarAndPeace.txt", "bragging");
    ...
    public void bigFileTest() throws IOException {
        ...
        List<Pair<Integer>> actual = SubStringFinder.findSubString("bigFile.txt", "aba");
        List<Pair<Integer>> expected = List.of(Pair.create(0, 12), Pair.create(10000001, 12));
        assertEquals(actual, expected);
        FileCreator.deleteFile("bigFile.txt");
    }
