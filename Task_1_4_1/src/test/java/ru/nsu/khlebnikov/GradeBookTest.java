...
public class GradeBookTest {
    ...
    public void myGradeBookTest() throws IOException {
        ...
        System.out.println(gradeBook.getAverageMark());
...
//        Assertions.assertEquals("0", gradeBook.getAverageMark());
//        Assertions.assertEquals("0", gradeBook.getAverageRedDiplomaMark());
...
//        Assertions.assertEquals("5", gradeBook.getAverageMark());
//        Assertions.assertEquals("5", gradeBook.getAverageRedDiplomaMark());
